    ...
    def get(self, request, idde=None):
        if idde is None:
            ...
            for noiDungDe in SetNoiDungDe:
                if noiDungDe.cau_hoi.loai_cau_hoi == 'DT':
                    chuoi = noiDungDe.cau_hoi.noi_dung
                    list_cauhoi_split = re.split(r'(<input>)', chuoi)
                    dict_cauhoi_DT[noiDungDe.thu_tu_cau] = list_cauhoi_split
