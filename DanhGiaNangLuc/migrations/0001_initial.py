# Generated by Django 5.0.6 on 2024-08-16 18:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(blank=True, choices=[('ly', 'Vật Lý'), ('hoa', 'Hóa Học'), ('sinh', 'Sinh Học'), ('su', 'Lịch Sử'), ('dia', 'Địa Lý'), ('gdcd', 'Giáo dục kinh tế và pháp luật')], max_length=4, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loai_de', models.CharField(choices=[('DGNL', 'Đánh giá năng lực HCM'), ('DGNLHN', 'Đánh giá năng lực Hà Nội')], default='DGNL', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nguoi_lam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='danhgiannangluc_luotthi_set', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='NoiDungDe',
